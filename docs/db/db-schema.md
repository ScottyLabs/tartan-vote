...
### Field Descriptions
- `id`: Primary Key. The id for the voter. Autogenerated.
- `event_id`: The event for which this voter is for. References [Events](db-schema.md#events).
- `voter_id`: The user who 'owns' this voter. References [Users](db-schema.md#users)
- `proxy`: The name of the person getting voted for, if any. Null if voter is not a proxy.
...
### Field Descriptions
- `id`: Primary Key. The id for the voter. References [Voters](db-schema.md#voters).
