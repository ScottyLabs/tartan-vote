...
### Field Descriptions
- `user_id`: Primary Key. The id for the user in the session. References [Users](db-schema.md#users).
- `session_id`: Primary Key. The id for the session. References [Sessions](db-schema.md#sessions).
