...
| --- | --- | --- | --- |
| Service | `tartan-vote` | `packages.tartan-vote` | `api.tartan.vote` |
| Site | `frontend` | `packages.frontend` | `tartan.vote` |
...
`https://api.tartan.vote/auth/callback` (plus staging/PR variants).
