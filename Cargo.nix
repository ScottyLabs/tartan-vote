  ...
  internal = rec {
    ...
    crates = {
      ...
      "backend" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter; src = ./backend/crates/voting-app; };
        dependencies = [
          {
            name = "axum";
            packageId = "axum";
      ...
      "entity" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter; src = ./backend/crates/entity; };
        dependencies = [
          {
            name = "sea-orm";
            packageId = "sea-orm";
      ...
      "migration" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter; src = ./backend/crates/migration; };
        dependencies = [
          {
            name = "sea-orm-migration";
            packageId = "sea-orm-migration";
      ...
      "sea-orm" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "macros" "mock" "postgres-array" "runtime-tokio" "runtime-tokio-rustls" "rust_decimal" "schema-sync" "sea-query-sqlx" "sea-schema" "serde_json" "sqlite-use-returning-for-3_35" "sqlx" "sqlx-dep" "sqlx-postgres" "time" "uuid" "with-chrono" "with-json" "with-rust_decimal" "with-time" "with-uuid" ];
      };
      "sea-orm-arrow" = rec {
      ...
      "voting-app-store" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter; src = ./backend/crates/voting-app-store; };
